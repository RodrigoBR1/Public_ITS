...
By plotting the patents count added (that is, the sum of patents in agriculture, mining and data processing technologies per country), two conclussions can be drawn. First, that the main global intellectual property owners [^10] in this sector of the economy have always beenthe USA and China, with a minor participation of South Korea, Japan, Russia (just recently), Canada and Australia. Second, that this field of global power dynamics doesn't have the same historical inertia as the TIDR, because despite the top 10 most innovative countries overlap with the biggest capital goods exporters, just the USA and CHINA are the most dominant possitions and the rest of the world can be considered as a "subordinate" in the global intellectual property system. Given the lack of historical inertia but clear pattern (because the patent count rises specially after 20XX), this may be well considered as an emergent form of imperialism in the global economy.

[^10]: Considering that "family" implies patents that are in force in at least 2 countries at once (hence they are "related" as family) and allow for the inventor to protect the technology from reproduction without permission.
