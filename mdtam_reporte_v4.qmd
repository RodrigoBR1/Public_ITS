...
operationalization$Dimension <- add_breaks(operationalization$Dimension)
operationalization$Empirical_Proxy <- add_breaks(operationalization$Empirical_Proxy)
operationalization$Reason_for_Selection <- add_breaks(operationalization$Reason_for_Selection)
...
2. **Hypothesis 2:** Latin American economies can be understood as a peripherical or subordinate region in the global economy, based on the historical analysis developed through Marxist Dependency Theory. In this line, it was expected that the countries in the region would have a high dependency on technology imports, a low relative position in the global intellectual property system and a net inflow of FDI in relation to their capital formation. This is based on the historical analysis of the region, which has been characterized by the extraction of raw materials and the import of capital goods, and the lack of a strong local industry that can compete in the global market. 
...
Second, of the five continents, only Europe seems to have a relatively diverse set of countries involved in investing in other territories, with a strong financial output of G20 nations but also smaller economies like Switzerland or Denmark. In a global perspective, the data suggest that some of the main net investors currently are the Netherlands, Japan, Canada and South Africa. Meanwhile, some other countries with high financial output are pointed to possibly operate as *tax havens* (like Cyprus or Luxembourg, that rank 14 and 10 in the Corporate Tax Haven Index (CTHI) by the Tax Justice Network [@CTHI2024]) and therefore shouldn't be considered imperialistic; or be considered as *administrative centers* for the economic power of global corporations, and therefore should be observed in detail as key nation-states that intertwine with imperialistic dynamics performed by privately owned transnational capital. From the main net investors recognized, it should be pointed that Japan seems to be the only steadily but slowly growing in time, while Canada and South Africa show volatile yet very positive trends.
...
The structure of this analysis is as follows: first, the authors will present the financial and innovation power data proxies (respectively, net GFCF and patents count) for the selected countries, and then the TIDR data (logistical power) for the same countries. The data will be displayed in longitudinal linear plots for each indicator, and the analysis will be written below each plot.
...
# Conclusions and reflections on the data

The analysis of the International Technological Subordination (ITS) indicators provides valuable insights into the hierarchical relations between countries in the global economy of agriculture and mining key commodities; in this case, machinery and data technologies that allow for an overall better raw material extraction process. Particularly, we suggest that the data allows to arrange economies around the globe according to the power they have to influence (or be influenced) by what other economies have to offer in the international division of labour. Therefore, relatively powerful economies like China, Netherlands, Brazil or the USA can be easily differentiated from relatively weak economies like African states or some Latin American states such as Paraguay or Bolivia. For this reason, the authors argue that the gathered data (as well as the ITS theoretical framework that guided its collection) suggests that technological dependency, innovation capacity, and financial subordination are indeed key dimensions that can reveal the relative position of a country in the global economic landscape.

The authors suggest that the dataset created should be taken as an starting point to further explore global dynamics of production in key technified assets, through selection of other technologies of interest to be tracked down through HS codes in trade and CPC codes in patent data; and ideally more granular FDI data also.

### Key findings summary

1. **Technological Dependency**: The TIDR analysis shows that most countries are net importers of technified capital goods in agriculture and mining, with a few exceptions like China and the USA, which have maintained a dominant position as net exporters. This indicates a high level of technological dependency for many countries, particularly in Africa and Latin America.

2. **Innovation Capacity**: The patent data reveals that the USA and China are the leading countries in terms of internationalized patents, indicating their strong position in the global intellectual property system. Other countries, such as Japan and South Korea, also show significant innovation capacity, while most Latin American countries lag behind.

3. **Financial Subordination**: The net FDI as a percentage of GFCF indicates that many countries, especially in Latin America, are net receivers of foreign direct investment, suggesting a high level of financial subordination. This is particularly evident in countries like Chile and Bolivia, which consistently receive more FDI than they send out.

### Reflections

The ITS framework provides a useful lens to understand the dynamics of technological and financial subordination in the global economy. The data highlights the persistent inequalities and the concentration of technological and financial power in a few dominant countries in a very large dataset. This has important implications for policy-making and international relations, as it underscores how just a handful of countries control the production and trade of technified fixed capital.

Future research should focus on refining the ITS indicators and exploring additional key material dimensions of subordination, such as food or energy industries. Moreover, a more detailed analysis of the role of transnational corporations and tax havens in the global financial system could provide further insights into the mechanisms of economic domination and subordination, and corrections in its assesment through data.

Overall, the ITS dataset and its analysis offer a simple but clear view of the global economic hierarchies and the challenges faced by subordinate countries in achieving technological and economic sovereignty.
